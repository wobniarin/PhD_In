...
\advisorone{Dra. Monica Aragues Penalba}
\advisortwo{Dr. Andreas Sumper} % Comenta la linia si nomes hi ha un director
\affone{(UPC, Spain)}
\afftwo{(UPC, Spain)}
\affthree{(NTNU, Norway)}
\afffour{(DTU, Denmark)}
\afffive{(NTNU, Norway)}
\affsix{(DTU, Denmark)}
\place{Barcelona}
...
First printing, December 2020  \par
\vspace{3mm}
% ISBN:
}
...
\input{ChapterIntro/ChapterIntro}
%\input{ChapterEVABM/ChapterEVABM}
%\input{ChapterFlowBasedMarket/ChapterFlowBasedMarket} %\input{ChapterDAMM/ChapterDAMM} %energycon2016
%\input{ChapterLFM/ChapterLFM}
%\input{ChapterDSOOptimization/ChapterDSOOptimization}
%\input{ChapterADMM/ChapterADMM}
