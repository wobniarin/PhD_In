...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\columnwidth ]{ChapterFlexServices/Figures/ENVELOPES.png}
	   %\vspace*{-8cm}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\columnwidth ]{ChapterFlexServices/Figures/PRICE_SIGNAL.png}
	   %\vspace*{-8cm}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\columnwidth ]{ChapterFlexServices/Figures/SYSTEM_ORIENTED.png}
	   %\vspace*{-8cm}
